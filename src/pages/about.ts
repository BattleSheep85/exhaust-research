...
export function renderAbout(): string {
  ...
  return layout('About', 'About Exhaustive — AI-powered product research.', `
<div class="container prose" style="padding:4rem 1.5rem;max-width:48rem;margin:0 auto">
<h1 style="font-size:2rem;font-weight:800;color:var(--text);margin-bottom:2rem">About Exhaustive</h1>
...
<p>Exhaustive was built to fix that. When you ask a question here, we don't just check one source — we scrape Reddit discussions, review sites, manufacturer specs, forums, and more. Then we feed everything to AI and get a brutally honest analysis.</p>
